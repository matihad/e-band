package mahdihadian.gholhak.ehealth.IntroSlider;
...
import mahdihadian.gholhak.ehealth.Register.LoginActivity;
...
public class IntroSliderActivity extends AppCompatActivity {
    ...
    private void showDots(int pageNumber){
        ...
        layoutDots.removeAllViews();// in hame SHADIDAN MOHEM***
